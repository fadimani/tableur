public class Soustraction extends OperationBinaire{
    ...
    public Soustraction(Cell cell1, Cell cell2) {
        casesInOperation.add(cell1);
        casesInOperation.add(cell2);
    }

    public Soustraction(Cell cell, Formule formule) {
    ...
    public Soustraction(Formule formule, Cell cell) {
        casesInOperation.add(cell);
        formulesInOperation.add(formule);
        casesInOperation.addAll(formule.casesInOperation);
    ...
    public Soustraction(Formule formule1, Formule formule2) {
